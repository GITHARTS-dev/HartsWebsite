...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/electronics', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/electronics/:path*', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/innai', destination: '/what-we-deliver', permanent: true },
      { source: '/innai/:path*', destination: '/what-we-deliver', permanent: true },
      { source: '/expert-fabrication', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/expert-fabrication/:path*', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/sheet-metal', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/machining', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/castings', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/manufacturing-lines-and-sites', destination: '/what-we-deliver/manufacturing', permanent: true },
      { source: '/manufacturing-lines-and-sites/:path*', destination: '/what-we-deliver/manufacturing', permanent: true },
