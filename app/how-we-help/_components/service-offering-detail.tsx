...
const serviceBodyContent: Record<string, ServiceBodyContent> = {
  ...
  transformation: {
    challenge:
      "Large programmes report green status while value quietly leaks. Dependencies, adoption, and benefit definitions drift apart faster than steering forums can catch them, and the gap between announced ambition and realised value widens quarter by quarter.",
    howWeHelp: [
      "We turn broad transformation ambition into a managed delivery system: scope architecture, governance, milestones, dependencies, value tracking, and adoption plans. The programme starts behaving like a portfolio of decisions, not a slogan.",
      "We stand up the Transformation Management Office and equip the senior steering forum with the cadence and information it needs to make trade-offs, remove blockers, and protect benefits as conditions change.",
    ...
    deliverables: [
      ...
      "Benefits realisation framework that tracks promise to P&L impact.",
    ],
    outcomes: [
  ...
  "gcc-setup": {
    ...
    howWeHelp: [
      "We stand up Global Capability Centers as enterprise capability platforms. That means shaping the location strategy (informed by AI-driven labour-market analytics), the business case, the entity path (subsidiary, build-operate-transfer, or partner), governance, service catalogue, leadership architecture, and migration roadmap.",
      "We move work in disciplined waves. Knowledge-transfer protocols, service-level definitions, capacity planning, and quality controls protect business continuity while we build durable capability inside the centre.",
  ...
  sustainability: {
    ...
    howWeHelp: [
      "We move sustainability from aspiration to operating discipline. ESG materiality, strategic intent, capital allocation, operations, supply chain, governance, and reporting come together as one enterprise agenda rather than a parallel report.",
      "We define material priorities, baselines, science-aligned targets, decarbonisation pathways across Scope 1, 2, and 3 emissions, and implementation initiatives with named owners and milestones. Pledges turn into plans.",
      "We build the evidence base, AI-supported data layer, and reporting rhythm required for credible disclosure aligned to TCFD, ISSB, GRI, SASB, and CSRD. The same rigour holds up in the harder conversations with investors, regulators, customers, and the board.",
    ],
    deliverables: [
  ...
  "people-and-organization": {
    ...
    howWeHelp: [
      ...
      "We turn organisation design into implementation: role mapping, transition planning, leadership alignment, communication, capability building, performance management, and adoption tracking. The new model lives beyond the launch announcement.",
    ],
    deliverables: [
      "Organisation design pack covering structure, spans, roles, and decision rights.",
...
/**
 * Render every capability hero as a single unified strong title:
 *   "{Capability} consulting."
 *
 * The previous heuristic (soft = all-but-last word, strong = last word +
 * "consulting.") produced clean output for "Innovation consulting." but
 * broke for compound names — "People &" / "Organization consulting.",
 * "GCC" / "Setup consulting.", etc. Keeping the title in one block
 * guarantees visual consistency across all eight capability pages.
 */
function ServiceTitle({ title }: { title: string }) {
  return {
    soft: undefined as string | undefined,
    strong: `${title} consulting.`,
  };
}
